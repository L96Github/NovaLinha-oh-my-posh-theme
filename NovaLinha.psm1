...
function Write-Theme {
    ...
    $prompt += Write-Prompt -Object $sl.PromptSymbols.SegmentForwardSymbol -ForegroundColor $sl.Colors.PromptBackgroundColor -BackgroundColor  $themeInfo.BackgroundColor

    Set-NewLine
    $prompt += Write-Prompt -Object $sl.PromptSymbols.NewLineSymbol -ForegroundColor $sl.Colors.WithForegroundColor 
    ...
    #Sets new line with entry symbol
    #Set-NewLine 
    #$prompt += Write-Prompt -Object $sl.PromptSymbols.ArrowForwardSymbol -ForegroundColor $lastColor
    $prompt
}

$sl = $global:ThemeSettings #local settings

$sl.PromptSymbols.NewLineSymbol = [char]::ConvertFromUtf32(0x255A)
$sl.PromptSymbols.ArrowForwardSymbol = [char]::ConvertFromUtf32(0x27A4)
